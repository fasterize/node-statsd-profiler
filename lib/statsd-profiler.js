...
exports.init = function init (stastdAddress, stastdconf, defaultSampleRate, transformKey, cleanTimer) {
  var stastdAddressMap = stastdAddress.split(':');
  initialized = true;
  ...
  exports.cleanTimer = cleanTimer || 5000;
